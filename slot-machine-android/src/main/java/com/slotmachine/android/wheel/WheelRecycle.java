/*
 * Android Wheel Control. https://code.google.com/p/android-wheel/ Copyright 2011 Yuri Kanivets Licensed under the
...
package com.slotmachine.android.wheel;
...
public class WheelRecycle {
	...
	/**
	 * Recycles items from specified layout. There are saved only items not included to specified range. All the cached
	 * items are removed from original layout.
	 * 
